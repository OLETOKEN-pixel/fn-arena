    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto py-6 lg:py-8">
        ...
        <Card className="p-6 lg:p-8">
          <div className="prose prose-invert max-w-none prose-headings:text-accent prose-headings:font-semibold prose-h2:text-xl prose-h2:mt-8 prose-h2:mb-4 prose-li:text-muted-foreground prose-p:text-muted-foreground">
