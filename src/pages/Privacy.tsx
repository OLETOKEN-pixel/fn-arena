    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto py-6 lg:py-8">
        ...
        <Card className="p-6 lg:p-8">
          <div className="prose prose-invert max-w-none prose-headings:text-success prose-headings:font-semibold prose-h2:text-xl prose-h2:mt-8 prose-h2:mb-4 prose-h3:text-lg prose-h3:mt-6 prose-h3:mb-3 prose-li:text-muted-foreground prose-p:text-muted-foreground">
            ...
            <p>
              OleBoy Token ("we", "us", "our") is operated by Marco Palumbo, based in Verona, Italy. We act as the "data controller" for the personal data processed in connection with the Platform.
            </p>
            <p>
